...
# 1. מחוז
district = st.selectbox("מחוז", ["Center", "Jerusalem", "North", "South"])

# 2. רבעון איתור ראשון
q1 = st.selectbox("רבעון איתור ראשון", ["Q1", "Q2", "Q3", "Q4"])

# 3. רבעון איתור שני
q2 = st.selectbox("רבעון איתור שני", ["Q1", "Q2", "Q3", "Q4"])
...
type1 = st.selectbox("אופי איתור ראשון", types)
type2 = st.selectbox("אופי איתור שני", types)

# 6. ייעוד קרקע
land_use = st.selectbox("ייעוד קרקע", [
...
structure2 = st.radio("סוג מבנה איתור שני", ["קל", "קשיח"])
...
for land in ["Agricultural area", "Beach/ River", "Industrial & Employment",
             "Nature & Conservation", "Tourism & Commerce", "Village",
             "Urban & Residential", "Unknown & Other"]:
